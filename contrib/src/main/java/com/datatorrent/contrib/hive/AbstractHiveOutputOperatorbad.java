...
public abstract class AbstractHiveOutputOperatorbad<T,S extends HiveStore> extends AbstractStoreOutputOperator<T, HiveStore>
{
  ...
  private static final Logger logger = LoggerFactory.getLogger(AbstractHiveOutputOperatorbad.class);
  ...
  public AbstractHiveOutputOperatorbad()
  {
